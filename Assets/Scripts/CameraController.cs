...
public class CameraController : MonoBehaviour
{
	...
	void Start()
	{
		...
		offset = new Vector3(0, cameraTarget.transform.position.y + offsetHeight, cameraTarget.transform.position.z - offsetDistance);
	}
	...
	void Update()
	{
		...
		{
			rotate = Input.GetAxis("Mouse X")/10000f;
            
		} 
		else if(Input.GetAxis("Mouse X") > 0)
		{
			rotate = Input.GetAxis("Mouse X")/15000f;
